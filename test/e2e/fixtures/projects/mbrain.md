...
provides the database layer. MBrain stores, searches, and retrieves personal knowledge
...
MBrain uses RAG as its core query mechanism. The compiled truth pattern is a deliberate
